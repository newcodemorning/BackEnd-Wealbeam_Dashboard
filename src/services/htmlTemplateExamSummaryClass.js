...
/**
 * Generate the HTML for the Class Exam Summary PDF report.
 * @param {Object} data  - result of responseService.getClassExamSummary()
 * @param {string} qrCodeDataURL - base64 QR code image
 * @param {string|null} note - optional note from the request body
 */
export function generateClassExamSummaryHTML(data, qrCodeDataURL, note = null) {
...
<head>
    ...
    <title>Class Exam Summary Report - ${classInfo.className || 'Class'}</title>
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .class-info-box .class-name { font-size:16px; font-weight:800; margin-bottom:4px; }
        .class-info-box .class-meta { font-size:11px; opacity:.8; }
        .teacher-box { text-align:right; }
        .teacher-box .teacher-label { font-size:10px; opacity:.6; text-transform:uppercase; letter-spacing:.5px; }
        .teacher-box .teacher-name { font-size:13px; font-weight:700; }
...
<div class="container">
    ...
    <header class="header">
        <div class="logo-section">
            ...
            <div class="logo-tagline">Class Exam Summary Report — Questions Overview</div>
        </div>
    ...
    <div class="report-info">
        <div class="school-details">
            ...
            <div class="subtitle">Class Exam Summary Report</div>
    ...
    <div class="class-info-box">
        ...
        <div class="teacher-box">
            ...
            <div class="teacher-name">${classInfo.teacher?.name || 'No Teacher Assigned'}</div>
        </div>
    </div>
    ...
    <!-- Footer -->
    <div class="footer">
        <span>${classInfo.className || 'Class'} &mdash; ${school.name || 'School'}</span>
